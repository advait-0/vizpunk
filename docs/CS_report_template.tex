...
\begin{document}
    ...
    \begin{titlepage}      
        \begin{center}
            \includegraphics[width=3cm]{figures/vjti-logo.png}\\[0.5cm]
            {\LARGE Veermata Jijabai Technological Institute\\[0.5cm]
            Department of Electrical Engineering}\\[2cm]
            ...
            \linespread{1.2}\huge {
                ...
                Vizpunk \\ An innovation in portable, cheap and easily accessible dev kit for enthusiasts
            ...
            {\Large 
                ...
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%             
                % change the following line
                Lakshaya Singhal [211030034] \\ Vaidic Gupta [211030036] \\ Furquan Shiekh [211030041] \\ Advait Dhamorikar [211030045] \\ Raj Gupta [211030061] 
                % change end             
            }\\[1cm] 
            ...
            {\large 
                ...
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%             
                % change the following line                
                \emph{Supervisor:} Dr. H.B. Chaudhari}\\[1cm] % if applicable
            ...
            in \textit{Electrical Engineering}\\[0.3cm] 
            \vfill
